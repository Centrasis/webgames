...
var BusdriverCardDeck = /** @class */ (function (_super) {
    ...
    function BusdriverCardDeck(effects, scene, hl) {
        ...
        _this.stacks = [];
        _this.stacks.push(new SkatStack(CardGame_1.StackDirection.Undef, CardGame_1.StackType.Pop, "MainStack"));
        _this.stacks.push(new SkatStack(CardGame_1.StackDirection.Undef, CardGame_1.StackType.Push, "PushStack"));
        _this.stacks.push(new PyramidStack(CardGame_1.StackDirection.Undef, CardGame_1.StackType.Push, "Pyramid"));
        var cards = [];
...
var BusdriverGUI = /** @class */ (function (_super) {
    ...
    BusdriverGUI.prototype.ShowChallenge = function (bd, challenge) {
        ...
        this.AVotingUI = new CardGame_1.VotingUI(this.GUI, challenge.ChallengeText, challenge.Answers, bd, function (val) {
