...
var WizardCardDeck = /** @class */ (function (_super) {
    ...
    function WizardCardDeck(scene, hl) {
        ...
        _this.stacks = [];
        _this.stacks.push(new WizardStack(CardGame_1.StackDirection.Undef, CardGame_1.StackType.Pop, "MainStack"));
        _this.stacks.push(new WizardStack(CardGame_1.StackDirection.Undef, CardGame_1.StackType.Push, "PushStack"));
        _this.stacks.push(new WizardStack(CardGame_1.StackDirection.Undef, CardGame_1.StackType.Push, "Finished"));
        var cards = [];
...
var Wizard = /** @class */ (function (_super) {
    ...
    Wizard.prototype.onNotify = function (notification, invoker, target) {
        ...
        if (notification == "!reset") {
            ...
            this.localPlayer.SetPhase(CardGame_1.PlayerGamePhase.Spectating);
