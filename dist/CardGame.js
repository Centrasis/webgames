...
var CardGame = /** @class */ (function (_super) {
    ...
    CardGame.prototype.executeCommand = function (cmd, req) {
        var _this = this;
        if ("!join" == cmd) {
            new svebaselib_1.SVEAccount({ id: Number(req.invoker) }, function (user) {
    ...
    CardGame.prototype.onRequest = function (req) {
        ...
        if (typeof req.action === "string") {
            if (req.action.startsWith("!")) {
                if (req.target === undefined || req.target.type === svebaselib_1.TargetType.Game) {
                ...
                if (req.target !== undefined) {
                    if (req.target.type === svebaselib_1.TargetType.Game) {
                        ...
                        if (req.target.type === svebaselib_1.TargetType.Player) {
                            ...
                            if (req.target.type === svebaselib_1.TargetType.Entity) {
