...
import { BaseGameGUI, PlayerGamePhase, CardGame, CardStack, StackDirection, StackType, Card, Player, GameState, VotingUI, BaseCardDeck } from './CardGame';
...
var BusdriverGUI = /** @class */ (function (_super) {
    ...
    BusdriverGUI.prototype.ShowChallenge = function (bd, challenge) {
        ...
        this.AVotingUI = new VotingUI(this.GUI, challenge.ChallengeText, challenge.Answers, function (val) {
